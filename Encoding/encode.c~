...
int idx,idx2,blks,left_over;
   // Since 3 input bytes = 4 output bytes, figure out how many even sets of 3 input bytes there are and process those. Multiplying by the equivilent of 3/3 (int arithmetic) will reduce a number to the lowest multiple of 3.
